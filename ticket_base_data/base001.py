...
if __name__ == '__main__':
    ...
    pro = ts.pro_api()
    df = pro.report_rc(ts_code='', report_date='20240120')

    # 指定要插入的列名
    selected_columns =['ts_code', 'name', 'report_date', 'report_title', 'report_type',
       'classify', 'org_name', 'author_name', 'quarter', 'op_rt', 'op_pr',
       'tp', 'np', 'eps', 'pe', 'rd', 'roe', 'ev_ebitda', 'rating',
       'max_price', 'min_price']  # 这里是你选择的列名
